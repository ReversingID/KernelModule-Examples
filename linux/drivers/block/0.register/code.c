...
/*
    ...
    Block Device adalah kategori device dengan karakteristik data yang ditransfer
    merupakan potongan data dengan ukuran tetap.

    Ukuran Block umumnya 4096 byte, atau ditentukan oleh faktor lain seperti
    filesystem yang digunakan. Sebuah sector 
*/
